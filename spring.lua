...
local function drawCurl(start,baseLenght,width)
  for i = 1, precision do
    B.x = start.x + baseLenght/curls * i / precision
    B.y = start.y + width * math.sin(2 * math.pi * i / precision)
...
-- make spring
for i=1,curls do
  curl = drawCurl(C,3/2*meter,meter/2)
  C.x = curl.x
end
-- make hooking
C.x = C.x + meter/6
